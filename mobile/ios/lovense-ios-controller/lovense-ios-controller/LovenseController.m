...
@implementation LovenseDeviceConnectionInfo

- (id) initWithService:(CBUUID*)serviceUUID
                transmit:(CBUUID*) transmitCharacteristicUUID
                 receive:(CBUUID*) receiveCharacteristicUUID
{
    self = [super init];
...
+ (NSArray*) connectionInfo {
    return @[
             [[LovenseDeviceConnectionInfo alloc] initWithService:[CBUUID UUIDWithString:@"6E400001-B5A3-F393-E0A9-E50E24DCCA9E"]
                                                         transmit:[CBUUID UUIDWithString:@"6E400002-B5A3-F393-E0A9-E50E24DCCA9E"]
                                                          receive:[CBUUID UUIDWithString:@"6E400003-B5A3-F393-E0A9-E50E24DCCA9E"]],
             [[LovenseDeviceConnectionInfo alloc] initWithService:[CBUUID UUIDWithString:@"53300001-0023-4bd4-bbd5-a6920e4c5653"]
                                                         transmit:[CBUUID UUIDWithString:@"53300002-0023-4bd4-bbd5-a6920e4c5653"]
                                                          receive:[CBUUID UUIDWithString:@"53300003-0023-4bd4-bbd5-a6920e4c5653"]]
    ];
}

+ (NSSet*) lushPeripheralNames {
    return [NSSet setWithObjects:@"LVS-S001", @"LVS-Lush40", nil];
}

+ (NSSet*) hushPeripheralNames {
    return [NSSet setWithObjects:@"LVS-Z001", nil];
}

+ (void) createWithPeripheral:(CBPeripheral*)peripheral connectionInfo:(LovenseDeviceConnectionInfo*)connectionInfo onReady:(void(^)(LovenseVibratorController*, NSError*))ready {
    LovenseVibratorController* vibe = [LovenseVibratorController alloc];
    (void)[vibe initWithPeripheral:peripheral
        service:connectionInfo.serviceUUID
        transmitCharacteristic:connectionInfo.transmitCharacteristicUUID
        receiveCharacteristic:connectionInfo.receiveCharacteristicUUID
